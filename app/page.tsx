        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-4">
            ...
            <div className="flex flex-wrap gap-3 justify-center mb-12">
              <Button asChild variant="outline" size="default" className="bg-green-600 hover:bg-green-700 text-white border-green-600 transition-all duration-200">
              ...
              <Button asChild variant="outline" size="default" className="bg-red-600 hover:bg-red-700 text-white border-red-600 transition-all duration-200">
              ...
              <Button asChild variant="outline" size="default" className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white border-purple-600 transition-all duration-200">
